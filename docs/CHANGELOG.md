...
### Added
- `config`: Add retries for snapshots by @ddkasa

### Removed
- `whenever`: Remove deprecated methods by @ddkasa
...
[0.7.0]: https://github.com/ddkasa/textual-timepiece/compare/v0.6.0..v0.7.0
